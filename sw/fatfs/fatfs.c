...
int main(void)
{
...
#endif
	char line[100];
	char string[] = "khajsdfhasdfhasldjkfhalskdjfhasjkdfhasdfhaslkdjfhasdfjasd\n";
	int count = 0;
	...
	fr = f_open(&fp, "0:blabla.txt", FA_READ);
#if PRINT_INFO == 1
...
#if WRITE_TEST == 1
	fr = f_open(&fp, "0:piet.txt", FA_CREATE_ALWAYS | FA_WRITE);
#if PRINT_INFO == 1
