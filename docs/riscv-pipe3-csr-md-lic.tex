...
\draw[] (15,-5) -- ++(3,0) coordinate (w) -- ++(0,5.333);
...
% ALU
\draw[] (19,3) -- ++(1,-1) -- ++(0,-1.333) -- ++(-1,-1.0) -- ++(0,3.333);
\draw[-latex] (18,0.333) -- ++(1,0);
\draw[-latex] (18,2.667) -- ++(1,0);
\draw[-latex] (18,1.667) -- ++(1,0);
\draw[-latex] (18.5,2.667) -- ++(0,3.5) -- ++(-20.5,0) -- ++(0,-7.667) -- ++(2,0);

% ALU out
\draw[-latex] (20,1.333) -- ++(2,0) -- ++(0,-4.0) coordinate (x) -- ++(-2,0);
\draw[] (20,-2+0.1667/2) rectangle node {fwrd} ++(-1,-1.5);

\draw[-latex] (19,-2.667) -- ++(-3,0) coordinate (z) -- ++(0,5) -- ++(1,0);
\draw[-latex] (16,1.333) -- ++(1,0);
%\draw[-latex,red] (z) -- ++(0,-8) -- ++(-18,0) -- ++(0,8) -- ++(2,0);

\draw[-latex] (x) -- ++(0,-7) -- ++(-13,0) coordinate (y) -- ++(0,10) -- ++(0.667,0) node[below,yshift=-7pt] {rd};
;
\end{tikzpicture}
